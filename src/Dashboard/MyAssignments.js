...
const MyAssignments = ({ studentId }) => {
    ...
    return (
        <div className="p-6 theme-secondary-bg rounded-lg relative">
            <div className="flex justify-between items-center">
                <h5 className="text-lg font-semibold mb-4 theme-primary-text flex items-center">My Assignments <p><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
