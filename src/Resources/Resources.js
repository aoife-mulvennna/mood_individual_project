...
const Resources = ({ limit }) => {
    ...
    return (
        <div className="p-6 theme-secondary-bg rounded-none shadow-sm border border-gray-200">
            <h5 className="text-lg font-semibold mb-2 theme-primary-text flex items-center border-b border-gray-300 pb-2 justify-center">Useful Resources<p className="mx-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
            ...
            <ul className="list-none pl-0">
                {resources.map((resource, index) => (
                    <li key={index} className="mb-4">
                        ...
                        <div className="text-xs theme-secondary-text ">{new Date(resource.resource_added_date).toLocaleDateString()}</div>
                    </li>
                ))}
            </ul>
            {limit && (
